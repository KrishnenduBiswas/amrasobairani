...
-(void)trashdata
{
  ...
  //  http://107.170.94.176/openSIS_CE6_Mobile/webservice/trash.php?staff_id=2&school_id=1&syear=2015&view=inbox&mail_ids=10
    ...
    ip_url *obj123=[[ip_url alloc]init];
    NSString *str123=[obj123 ipurl];
    NSString*str_checklogin=[NSString stringWithFormat:@"/parent/parent_trash.php?parent_id=%@&student_id=%@&syear=%@&view=%@&mail_ids=%@",parentid,student_id,s_year,view_select,member_ids];
    NSLog(@"kkkkkkkkkkk%@",str_checklogin);
    NSString *url12=[NSString stringWithFormat:@"%@%@",str123,str_checklogin];
...
-(IBAction)add:(id)sender
{
    ...
    mvc=[sb instantiateViewControllerWithIdentifier:@"p_compose"];
...
-(void)loaddata1
{
   // NSString *inbox=@"inbox";
    ...
    ip_url *obj123=[[ip_url alloc]init];
    NSString *str123=[obj123 ipurl];
    NSString*str_checklogin=[NSString stringWithFormat:@"/parent/parent_msg_inbox.php?parent_id=%@&student_id=%@&syear=%@&view=%@",parentid,student_id,s_year,view_select];
    NSLog(@"kkkkkkkkkkk%@",str_checklogin);
    NSString *url12=[NSString stringWithFormat:@"%@%@",str123,str_checklogin];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
            ...
            
        {
            ...
            self.ary_data1=[dictionary1 objectForKey:@"general_info"];
...
- (void)viewDidLoad {
  ...
  //  [self loaddata];
    ...
    course_period_title=[[NSMutableArray alloc]initWithObjects:@"Outbox",@"Groups",@"Trash",@"Compose",nil];
...
-(void)pickerDoneClicked1
{
    ...
    if ([term_flag isEqualToString:@"1"]) {
        ...
        UIStoryboard * sb=[UIStoryboard storyboardWithName:@"P_msg" bundle:nil];
        P_trash1 * mvc=[[P_trash1 alloc]init];
        mvc=[sb instantiateViewControllerWithIdentifier:@"p_tra"];
        [self.navigationController pushViewController:mvc animated:NO];
      ...
      else
      {
          ...
          UIStoryboard * sb=[UIStoryboard storyboardWithName:@"P_msg" bundle:nil];
          P_composeViewController * mvc=[[P_composeViewController alloc]init];
          mvc=[sb instantiateViewControllerWithIdentifier:@"p_compose"];
          [self.navigationController pushViewController:mvc animated:NO];
      }
...
//
// else if ([outbox_flag isEqualToString:@"1"]) {
//        courseperiodName.text=inbox_data;
...
//    }
//    
//  else  if ([grp_flag isEqualToString:@"1"]) {
...
//        [self.navigationController pushViewController:mgc animated:YES];
//    }
// else   if ([trash_flag isEqualToString:@"1"]) {
//        courseperiodName.text=inbox_data;
//        view_select=@"trash";
//        [MBProgressHUD showHUDAddedTo:self.view animated:YES];
//        [self loaddata1];
...
//            if ([inbox_data isEqualToString:@"Inbox"]) {
//                
//            
//            
//            
...
//          //  UIStoryboard *sb = [UIStoryboard storyboardWithName:@"msg" bundle:[NSBundle mainBundle]];
//            
//          if ([inbox_data isEqualToString:@"Groups"]) {
//               // MessageGroupController *mgc = [sb instantiateViewControllerWithIdentifier:@"msggroups"];
//             //   [self.navigationController pushViewController:mgc animated:YES];
//                grp_flag=@"1";
//            }
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // MAIL_ID
    ...
    NSLog(@"----------");
    UIStoryboard *s1=[UIStoryboard storyboardWithName:@"P_msg" bundle:nil];
    P_mailview *obj=[s1 instantiateViewControllerWithIdentifier:@"p_mail"];
