...
@interface P_WeekViewController ()<CLWeeklyCalendarViewDelegate,UIPickerViewDelegate,UIPickerViewDataSource,VRGCalendarViewDelegate>
...
@implementation P_WeekViewController
...
//    NSString *STAFF_ID_K=[DF objectForKey:@"iphone"];
   ...
   NSString*str_checklogin=[NSString stringWithFormat:@"/parent/parent_calendar.php?parent_id=%@&student_id=%@&syear=%@&action_type=%@&view_type=week&start_date=%@&end_date=%@&calendar_id=",parentid,student_id,s_year,assignment_data,startdate,lastdate];
