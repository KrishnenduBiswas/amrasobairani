...
@interface Add_requestViewController ()
{
...
@implementation Add_requestViewController
...
-(void)loaddata
{
    ...
    ip_url *obj123=[[ip_url alloc]init];
    NSString *str123=[obj123 ipurl];
    NSString*str_checklogin=[NSString stringWithFormat:@"/student/stu_schedule_request.php?action=add_view&student_id=%@&school_id=%@&syear=%@",student_id,s_year_id,s_year];
    NSLog(@"kkkkkkkkkkk%@",str_checklogin);
    NSString *url12=[NSString stringWithFormat:@"%@%@",str123,str_checklogin];
...
-(void)loadreqst
{
    ...
    ip_url *obj123=[[ip_url alloc]init];
    NSString *str123=[obj123 ipurl];
    NSString*str_checklogin=[NSString stringWithFormat:@"/student/stu_schedule_request.php?action=add_submit&student_id=%@&school_id=%@&syear=%@&subject_id=%@&course_id=%@&with_teacher_id=%@&not_teacher_id=%@&with_period_id=%@&not_period_id=%@&mp_id=%@",student_id,s_year_id,s_year,str,str2,strC3,strC4,strC5,strC6,mp_id];
    NSLog(@"kkkkkkkkkkk%@",str_checklogin);
    NSString *url12=[NSString stringWithFormat:@"%@%@",str123,str_checklogin];
