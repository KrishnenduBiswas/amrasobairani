...
@interface OutboxViewController: UIViewController<UIGestureRecognizerDelegate,UIPickerViewDataSource,UIPickerViewDelegate,UITextFieldDelegate,UITableViewDataSource,UITableViewDelegate,UIScrollViewDelegate>
{
    
    NSString *view_select,*trash_flag,*grp_flag;
    
    NSString *outbox_flag;
    NSString * member_ids;
