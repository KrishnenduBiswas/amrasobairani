...
#define kVRGCalendarViewTopBarHeight 0
#define kVRGCalendarViewWidth 568

#define kVRGCalendarViewDayWidth 44
#define kVRGCalendarViewDayHeight 40

@protocol VRGCalendarViewDelegate;
@interface P_VRGCalendarView : UIView<UITextFieldDelegate,UIPickerViewDataSource,UIPickerViewDelegate>
{
