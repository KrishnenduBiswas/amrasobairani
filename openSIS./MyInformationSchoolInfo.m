...
- (void)viewDidLoad {
    ...
    _table_cert.tableFooterView=[[UIView alloc]init];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // cell.lbl_activeornot.text
    NSString *active = [self nullChecker:[NSString stringWithFormat:@"%@",[[array_cert objectAtIndex:indexPath.row] objectForKey:@"STATUS"]]];
    if ([active isEqualToString:@"Active"]) {
        cell.lbl_activeornot.text=active;
        cell.lbl_activeornot.backgroundColor=[UIColor greenColor];
    }
    else
    {
        cell.lbl_activeornot.text=active;
        cell.lbl_activeornot.backgroundColor=[UIColor  redColor];
