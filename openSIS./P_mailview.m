...
@interface P_mailview ()<UIActionSheetDelegate>
{
...
-(void)trashdata
{
    ...
    NSString*str_checklogin=[NSString stringWithFormat:@"/parent/parent_trash.php?parent_id=%@&student_id=%@&syear=%@&view=%@&mail_ids=%@",parentid,student_id,s_year,self.view_select,self.MAIL_ID];
...
-(void)reply
{
  ...
  //  http://107.170.94.176/openSIS_CE6_Mobile/webservice/compose_mail_view.php?staff_id=2&school_id=1&syear=2015&mp_type=QTR&mp_id=16&action_type=reply&mail_id=1
    ...
    NSString *str123=[obj123 ipurl];
    NSString*str_checklogin=[NSString stringWithFormat:@"/parent/parent_compose_mail_view.php?parent_id=%@&student_id=%@&syear=%@&action_type=reply&mail_id=%@",parentid,student_id,s_year,self.MAIL_ID];
    NSLog(@"kkkkkkkkkkk%@",str_checklogin);
    NSString *url12=[NSString stringWithFormat:@"%@%@",str123,str_checklogin];
...
-(void)loaddata1
{
 ...
 //   NSString *school_id123456=[NSString stringWithFormat:@"%@",[appDelegate.dic objectForKey:@"SCHOOL_ID"]];
    ip_url *obj123=[[ip_url alloc]init];
    NSString *str123=[obj123 ipurl];
    NSString*str_checklogin=[NSString stringWithFormat:@"/parent/parent_compose_mail_view.php?parent_id=%@&student_id=%@&syear=%@&action_type=&mail_id=%@",parentid,student_id,s_year,self
                             .MAIL_ID];
    NSLog(@"kkkkkkkkkkk%@",str_checklogin);
    NSString *url12=[NSString stringWithFormat:@"%@%@",str123,str_checklogin];
