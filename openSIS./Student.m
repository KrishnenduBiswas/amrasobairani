...
#import "goal.h"
@interface Student ()<UITableViewDataSource,UITableViewDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.LABEL_NAME.text = [self nullChecker:[[array_studentData objectAtIndex:indexPath.row] objectForKey:@"FULL_NAME"]];
    cell.LABEL_ID.text = [self nullChecker:[[array_studentData objectAtIndex:indexPath.row] objectForKey:@"STUDENT_ID"]];
    ...
    {
          cell.label_grade.text = [self nullChecker:[[array_studentData objectAtIndex:indexPath.row] objectForKey:@"GRADE_ID"]];
    }
    
    if ([self.flag_check isEqualToString:@"Y"]) {
        cell.s_ac.text=[self nullChecker:[[array_studentData objectAtIndex:indexPath.row] objectForKey:@"ACTIVE"]];
        cell.c_s_a.text=[self nullChecker:[[array_studentData objectAtIndex:indexPath.row] objectForKey:@"ACTIVE_SCHEDULE"]];
        cell.s_s_hid.hidden=NO;
        cell.c_s_hidd.hidden=NO;
    ...
    else
    {
        ...
        cell.s_s_hid.hidden=YES;
        cell.c_s_hidd.hidden=YES;
        cell.s_ac.hidden=YES;
        cell.c_s_a.hidden=YES;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *std_id= [self nullChecker:[[array_studentData objectAtIndex:indexPath.row] objectForKey:@"STUDENT_ID"]];
    NSString *std_name=[self nullChecker:[[array_studentData objectAtIndex:indexPath.row] objectForKey:@"FULL_NAME"]];
    NSUserDefaults *df=[NSUserDefaults standardUserDefaults];
    
    
    [df setObject:std_id forKey:@"std_id"];
    [df setObject:std_name forKey:@"std_name"];
...
//    goal *slc = [storyBoard instantiateViewControllerWithIdentifier:@"goal"];
//       slc.studentID = [[array_studentData objectAtIndex:indexPath.row] objectForKey:@"STUDENT_ID"];
//      slc.studentName = [[array_studentData objectAtIndex:indexPath.row] objectForKey:@"FULL_NAME"];
//    [self.navigationController pushViewController:slc animated:YES];
