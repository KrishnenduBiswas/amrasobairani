...
@interface P_ResultGroupMemberController ()
...
@implementation P_ResultGroupMemberController
{
...
-(void)loaddata1
{
    ...
    NSString*str_checklogin=[NSString stringWithFormat:@"/parent/parent_message_group.php?parent_id=%@&student_id=%@&syear=%@&action_type=add_grp_member_view&grp_id=%@&last=%@&first=%@&username=%@&profile=%@&_dis_user=%@&_search_all_schools=%@",parentid,student_id,s_year,self.group_id,self.str_last,self.str_first,self.str_usr,self.str_profile,self.str_disusr,self.str_allsch];
...
//    }
   ...
   //  http://107.170.94.176/openSIS_CE6_Mobile/webservice/message_group.php?staff_id=2&school_id=1&syear=2015&action_type=member_insert&grp_id=4&members=[{"id":"50","profile":"parent"}]
    ...
    NSString *urlStr = [NSString stringWithFormat:@"/parent/parent_message_group.php"];
