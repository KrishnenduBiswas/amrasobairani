...
@implementation EditGroupController
...
- (void)viewDidLoad {
    ...
    self.text_title.text = [NSString stringWithFormat:@"%@",[self.mainDict objectForKey:@"GROUP_NAME"]];
    self.text_final_grade.text = [NSString stringWithFormat:@"%@",[self.mainDict objectForKey:@"DESCRIPTION"]];
}
...
-(void)savedata
{
   // http://107.170.94.176/openSIS_CE6_Mobile/webservice/message_group.php?staff_id=2&school_id=1&syear=2015&action_type=edit_grp&grp_id=4&txtGrpName=test //group&txtGrpDesc=
    ...
    NSString*str_checklogin=[NSString stringWithFormat:@"/message_group.php?staff_id=%@&school_id=%@&syear=%@&action_type=edit_grp&grp_id=%@&txtGrpName=%@&txtGrpDesc=%@",STAFF_ID_K,school_id,year_id,group_id,title_text1,desc];
