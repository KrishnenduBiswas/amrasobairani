...
#import "msg1.h"
#import "TeacherDashboardViewController.h"
#import "S_SearchmemberViewController.h"
#import "SdashboardViewController.h"
#import "S_ReportViewController.h"


@interface S_ShowmemberViewController ()
{
...
@implementation S_ShowmemberViewController
{
...
-(void)loaddata1
{
    ...
    NSString*str_checklogin=[NSString stringWithFormat:@"/student/stu_message_group.php?student_id=%@&school_id=%@&syear=%@&action_type=selected_grp_view&grp_id=%@",student_id,s_year_id,s_year,self.groupid];
...
- (IBAction)action_addMembers:(id)sender {
    ...
    S_SearchmemberViewController *sgmc = [sb instantiateViewControllerWithIdentifier:@"s_searchmbrr"];
...
-(void)deletemembers
{
    ...
    ip_url *obj123=[[ip_url alloc]init];
    NSString *str123=[obj123 ipurl];
    NSString*str_checklogin=[NSString stringWithFormat:@"/student/stu_message_group.php?student_id=%@&school_id=%@&syear=%@&action_type=delete_group&grp_id=%@",student_id,s_year_id,s_year,self.groupid];
    NSLog(@"kkkkkkkkkkk%@",str_checklogin);
    NSString *url12=[NSString stringWithFormat:@"%@%@",str123,str_checklogin];
