...
@interface P_slideViewController : UIViewController
{
    
    
    
    NSString *std_flag,*str_term1;
    NSMutableArray *ary_stdname,*ary_stdid;
    NSString *str_name;
    BOOL s_name;
    NSString *std_id;

    
    IBOutlet UIView * stu_nameview;
    ...
    IBOutlet UITextField *currentSchool,*schoolYear,*term,*subject,*course,*coursePeriod, *courseperiodName,*student_name;
