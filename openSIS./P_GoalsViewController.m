...
@implementation P_GoalsViewController
...
-(void)loaddata1
{
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        {
            sinfo=[dictionary1 objectForKey:@"goals"];
            NSLog(@"sinfo----%@",sinfo);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    P_goalcellTableViewCell *cell=[tableView dequeueReusableCellWithIdentifier:@"p_gocell"];
    
    
    cell.begindate.text = [self nullChecker:[NSString stringWithFormat:@"%@",[[sinfo objectAtIndex:indexPath.row] objectForKey:@"START_DATE"]]];
    cell.enddate.text = [self nullChecker:[NSString stringWithFormat:@"%@",[[sinfo objectAtIndex:indexPath.row] objectForKey:@"END_DATE"]]];
    cell.goaltitle.text = [self nullChecker:[NSString stringWithFormat:@"%@",[[sinfo objectAtIndex:indexPath.row] objectForKey:@"GOAL_TITLE"]]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIStoryboard *storyBoard = [UIStoryboard storyboardWithName:@"P_Student" bundle:[NSBundle mainBundle]];
    P_goalview_ViewController *mia = [storyBoard instantiateViewControllerWithIdentifier:@"gv1"];
