...
//        [self addSubview:viewback];
   ...
   // }
    ...
    //Grid white lines
  //  CGContextSetStrokeColorWithColor(context, [UIColor whiteColor].CGColor);//atha change korlum
    CGContextBeginPath(context);
    ...
    //Grid dark lines
    CGContextSetStrokeColorWithColor(context, [UIColor colorWithHexString:@"0xcfd4d8"].CGColor);//akhane color change hoie.
    CGContextBeginPath(context);
