...
#import "ForgotpparentViewController.h"
...
@implementation ForgotpparentViewController
@synthesize pr;
- (void)viewDidLoad {
    [super viewDidLoad];
    [self selectprofile];
    ...
    else
    {
        ...
        dispatch_async(dispatch_get_global_queue( DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
            ...
            dispatch_async(dispatch_get_main_queue(), ^{
                ...
                [self performSelector:@selector(forgotparent:) withObject:nil afterDelay:2];
            });
        });
...

{
    ...
    else if ([str_txt isEqualToString:@"staff"])
    {
        ...
        forgotpViewController *obj=[s instantiateViewControllerWithIdentifier:@"forgotpstaff"];
    ...
    else if ([str_txt isEqualToString:@"student"])
    {
        ...
        UIStoryboard *s=[UIStoryboard storyboardWithName:@"Main" bundle:nil];
        ForgotusernameViewController *obj=[s instantiateViewControllerWithIdentifier:@"forgotpassword"];
