...
#import "S_ShowmemberViewController.h"
#import "SdashboardViewController.h"
#import "S_ReportViewController.h"

@interface S_msg_groupViewController ()
{
...
@implementation S_msg_groupViewController
...
- (void)viewDidLoad {
    ...
    course_period_title=[[NSMutableArray alloc]initWithObjects:@"Inbox",@"Outbox",@"Compose",@"Trash", nil];
...
-(void)pickerDoneClicked1
{
    ...
    if ([term_flag isEqualToString:@"1"]) {
        if ([inbox_data isEqualToString:@"Inbox"]) {
            ...
            MsgViewController*msgvc = [sb instantiateViewControllerWithIdentifier:@"msg"];
...
{
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"StudentDashboard" bundle:[NSBundle mainBundle]];
    S_ShowmemberViewController *sgmc = [sb instantiateViewControllerWithIdentifier:@"s_showmbrr"];
...
{
    UIStoryboard *sb = [UIStoryboard storyboardWithName:@"StudentDashboard" bundle:[NSBundle mainBundle]];
    S_AddgroupViewController *agc = [sb instantiateViewControllerWithIdentifier:@"saddgrp"];
