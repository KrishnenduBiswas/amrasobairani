...
@interface pinfoViewController ()<UIPickerViewDataSource , UIPickerViewDelegate>
{
    ...
    NSString    * student_id,*view_select,*s_year,*s_year_id ,*mp_id ,*action_type,*parentid;
...
@implementation pinfoViewController
...
-(void)loaddata1
{
    ...
    NSString*str_checklogin=[NSString stringWithFormat:@"/parent/parent_school_info.php?parent_id=%@&student_id=%@&syear=%@",parentid,student_id,s_year_id];
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
            ...
            
        {
            ...
            sname.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"TITLE"]]];
            add.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"ADDRESS"]]];
            city.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"CITY"]]];
            stae.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"STATE"]]];
            tel.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"PHONE"]]];
            website.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"WWW_ADDRESS"]]];
            email.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"E_MAIL"]]];
            prin.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"PRINCIPAL"]]];
            zip.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"ZIPCODE"]]];
            
            base.text=[self nullChecker:[NSString stringWithFormat:@"%@",[sinfo objectForKey:@"REPORTING_GP_SCALE"]]];
