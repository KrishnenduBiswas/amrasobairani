...
- (void)viewDidLoad {
    ...
    NSAttributedString *str1 = [[NSAttributedString alloc] initWithString:@"Username" attributes:@{ NSForegroundColorAttributeName : [UIColor lightGrayColor] }];
...
{
    UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"Alert" message:msg delegate:nil cancelButtonTitle:nil otherButtonTitles:nil, nil];
    [alert show];
...

{
    ...
    else if ([str_txt isEqualToString:@"staff"])
    {
        ...
        forgotpstaffViewController *obj=[s instantiateViewControllerWithIdentifier:@"forgotpstaff"];
    ...
    {
        UIStoryboard *s=[UIStoryboard storyboardWithName:@"Main" bundle:nil];
        forgotpstaffViewController *obj=[s instantiateViewControllerWithIdentifier:@"forgotpparent"];
...
{
   // textField.font = [UIFontDescriptor f];
