...
@interface ComposeForClassController ()
...
@implementation ComposeForClassController
{
...
- (void)savedataongroups
{
    ...
    if (self.switch_onlystudent) {
        list_gpa_student = @"Y";
    }
    
    if (self.switch_onlyparent) {
        list_gpa_parent = @"Y";
    }
